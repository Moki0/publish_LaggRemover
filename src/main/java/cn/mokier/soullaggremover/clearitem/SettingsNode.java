...
class SettingsNode {
    ...
    public SettingsNode(ConfigurationNode configurationNode) {
        ...
        try {
            warning =  configurationNode.getNode("warning").getList(TypeToken.of(Integer.class));
        } catch (ObjectMappingException e) {
            Chat.sendLangLoggerError("clearItems.error-settings-warning", false);
        }

        try {
            whiteList =  configurationNode.getNode("whiteList").getList(TypeToken.of(String.class));
        } catch (ObjectMappingException e) {
            Chat.sendLangLoggerError("clearItems.error-settings-whitelist", false);
        }
        ...
        try {
            ...
            Chat.sendLangLoggerError("clearItems.error-settings-worlds", false);
        }
    }
