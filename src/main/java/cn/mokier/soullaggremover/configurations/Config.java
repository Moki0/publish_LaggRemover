...
public class Config {
    ...
    public Config(SoulLaggRemover instance) {
    ...
    public void saveDefaultConfig() throws IOException {
        ...
        Path pathFile = Paths.get(path+"/config.conf");

        if(!pathFile.toFile().exists()) {
            Sponge.getAssetManager().getAsset(instance, "config.conf").get().copyToFile(pathFile, false, true);
        }
